...
const createMainRoutes = () => [
  ...
  { path: '/media-providers/image', element: <ProvidersWorkbenchPage fixedBrand="image" /> },
  { path: '/media-providers/video', element: <ProvidersWorkbenchPage fixedBrand="video" /> },
  { path: '/media-providers/audio', element: <ProvidersWorkbenchPage fixedBrand="audio" /> },
  { path: '/media-providers', element: <Navigate to="/media-providers/image" replace /> },
  { path: '/media-providers/*', element: <Navigate to="/media-providers/image" replace /> },
