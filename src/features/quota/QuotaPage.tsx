  ...
  return (
    <div className={styles.page} ref={revealRef}>
      <QuotaHeader
        ...
        currentPageRefreshing={loading || batchLoading}
        backgroundRefreshing={backgroundRefresh.running}
        backgroundDone={backgroundRefresh.done}
        backgroundTotal={backgroundRefresh.job?.total ?? 0}
        disableControls={disableControls}
        onRefreshCurrentPage={handleRefreshCurrentPage}
        onRefreshAll={() => void backgroundRefresh.startRefreshAll()}
      />
